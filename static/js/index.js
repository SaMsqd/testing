document.addEventListener("DOMContentLoaded", () => {
  ...
  const createFolderWIthPositions = (wrap) => {
    ...
    wrapper
      ...
      .addEventListener("click", () => {
        ...
        wrapper.querySelector(".select-project-btn").textContent = nameFolder;
  ...
  if (document.querySelector(".pos-pag")) {
    createFolderWIthPositions(".pos-pag");
    createFolderButton(".pos-pag");
  }
  if (document.querySelector(".edit-tab-1")) {
    createFolderWIthPositions(".edit-tab-1");
    createFolderButton(".edit-tab-1");
    // createFolder(".edit-tab-1");
  }
  ...
  if (document.querySelector(".pop-delete")) {
    handlerClosePopup(".pop-delete__exit", ".pop-delete");
  }
  ...
  // }
  if (document.querySelector(".pop-delete")) {
    document.querySelectorAll(".item-rent__delete").forEach((el) => {
      el.addEventListener("click", () => {
        document.querySelector(".popup-background").classList.add("active");
        document.querySelector(".pop-delete").classList.add("active");
      });
    });
  }
  if (document.querySelector(".pop-password")) {
  ...
  const createRegion = (button, body) => {
    ...
    addButton.addEventListener("click", () => {
      ...
      let region;
      if (button == ".pop-pos .regions__add") {
        region = `
        <div class="region">
          ...
          <div class="region__device">          
            <div class="region__device-btn">
              <div class="region__device-svg-wrap">
            ...
            <div class="project__dropdown-wrapper">
              <div class="body-panel__google-item folder active">
                <svg class="folder-device" width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="body-panel__google-item folder">
                <svg class="folder-device"width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="body-panel__google-item folder">
                <svg class="folder-device" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      `;
      } else if (button == ".edit__google .regions__add") {
        const checkbox = document.querySelector(".edit__google-all");
        console.log(checkbox);
        console.log("google");

        const state = checkbox.checked ? "" : "disabled";
        region = `
           <div class="region">
            <div class="region__browser">
                <label  class="gui-switch">
                    <input type="checkbox" role="switch" ${state}>
                </label>
            </div>
            <div class="search-folders regions-menu">
              <div class="select-btn regions-btn btn-reset" style="border-color: rgb(0, 118, 245);">
              ...
              <div class="region__device-btn">
                <div class="region__device-svg-wrap">
                    <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.41662 11.5665V11.6665H3.51662H17.4803H17.5803V11.5665V2.03314V1.93314H17.4803H3.51662H3.41662V2.03314V11.5665ZM0.998438 15.7998V14.2665H19.9984V15.7998H0.998438ZM3.51662 13.1998C3.06313 13.1998 2.67752 13.0406 2.35436 12.7197C2.03122 12.3988 1.87116 12.0162 1.87116 11.5665V2.03314C1.87116 1.58343 2.03122 1.20082 2.35436 0.879928C2.67752 0.559011 3.06313 0.399805 3.51662 0.399805H17.4803C17.9338 0.399805 18.3194 0.559011 18.6425 0.879928C18.9657 1.20082 19.1257 1.58343 19.1257 2.03314V11.5665C19.1257 12.0162 18.9657 12.3988 18.6425 12.7197C18.3194 13.0406 17.9338 13.1998 17.4803 13.1998H3.51662Z" fill="#0076F5" stroke="white" stroke-width="0.2" />
                    </svg>
                </div>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="region__delete">
                <svg width="15" height="17" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.475 3.16667V3.06667H1.375H0.6V1.48889H4.875H4.975V1.38889V0.6H10.025V1.38889V1.48889H10.125H14.4V3.06667H13.625H13.525V3.16667V14.7222C13.525 15.1849 13.364 15.5782 13.0397 15.9076C12.7154 16.237 12.329 16.4 11.875 16.4H3.125C2.671 16.4 2.28456 16.237 1.96033 15.9076C1.63605 15.5782 1.475 15.1849 1.475 14.7222V3.16667ZM11.975 3.16667V3.06667H11.875H3.125H3.025V3.16667V14.7222V14.8222H3.125H11.875H11.975V14.7222V3.16667ZM6.525 5.04444V12.8444H4.975V5.04444H6.525ZM10.025 5.04444V12.8444H8.475V5.04444H10.025Z" fill="#E50C00" stroke="#FFE7E6" stroke-width="0.2" />
                </svg>
            </div>
          </div>
        `;
      } else if (button == ".edit__yandex .regions__add") {
        const checkbox = document.querySelector(".edit__yandex-all");
        console.log(checkbox);
        console.log("yandex");
      ...
      editAllCheckBox(".edit__yandex-all", ".edit__yandex");
      editAllCheckBox(".edit__google-all", ".edit__google");
    });
  };
  //Удалить регион в  quiz
  const deleteRegion = () => {
    const deleteButtons = document.querySelectorAll(".region__delete");

    deleteButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
        e.target.closest(".region").remove();
        console.log("deell");
      });
    });
  };
  //Удалить все регионы в  quiz
  const deleteAllRegions = (button, body) => {
    const deleteBUtton = document.querySelector(`${button}`);

    deleteBUtton.addEventListener("click", () => {
      const regions = document.querySelectorAll(`${body}`);
      regions.forEach((region) => region.remove());
    });
  };
  if (document.querySelector(".edit .regions")) {
    deleteAllRegions(".edit__google .regions__delete", ".edit__google .region");
    deleteAllRegions(".edit__yandex .regions__delete", ".edit__yandex .region");
    createRegion(".edit__google .regions__add", ".edit__google .regions__body");
    createRegion(".edit__yandex .regions__add", ".edit__yandex .regions__body");
  }
  ...
  if (document.querySelector(".pop-pos")) {
    createRegion(".pop-pos .regions__add", ".pop-pos .regions__body");
    deleteRegion();
    deleteAllRegions(".pop-pos .regions__delete", ".pop-pos .region");
  ...
  const editPosChose = () => {
    const allItems = document.querySelectorAll(".edit-pos");
    const button = document.querySelector(".edit__positions-all input");

    allItems.forEach((el) => {
      const input = el.querySelector(".checkbox");
      input.addEventListener("click", () => {
        button.checked = false;
      });
    });
  ...
  const editAllPosChose = () => {
    const allItems = document.querySelectorAll(".edit-pos");
    const button = document.querySelector(".edit__positions-all");

    button.addEventListener("click", (e) => {
      allItems.forEach((el) => {
        const input = el.querySelector("input");

        input.checked = button.querySelector("input").checked;
      });
    });
  };
  ...
  if (document.querySelector(".all-positions")) {
    choseAllPositions();
  }
  itemsEvent();
  if (document.querySelector(".edit .edit__positions")) {
    editPosChose();
    editAllPosChose();
  }
  // Функционал выбора позиций для их удаления --------
  ...
  //Основные табы на странице edit
  if (document.querySelector(".edit")) {
    const tabs = document.querySelectorAll(".edit-tab");
    const allBodyTaB = document.querySelectorAll("[data-body]");

    tabs.forEach((el) => {
      el.addEventListener("click", () => {
        allBodyTaB.forEach((el) => {
          el.classList.remove("active");
        });
        tabs.forEach((el) => {
          el.classList.remove("active");
        ...
        const body = document.querySelector(`[data-body=${tabIndex}]`);
  ...
  //Удалить элемент из запроса edit
  const editDeleterPos = () => {
    const buttons = document.querySelectorAll(".edit-pos-delete");

    buttons.forEach((button) => {
      button.addEventListener("click", () => {
        button.closest(".edit-pos").remove();
      });
    });
  };
  editDeleterPos();

  //Общие чекбоксы для google и Яндекс edit
  const editAllCheckBox = (button, browser) => {
    const regions = document.querySelectorAll(
      `${browser} .regions .region__browser input`
    );
    const buttonglobal = document.querySelector(`${button}`);
    buttonglobal.addEventListener("click", () => {
      console.log(buttonglobal.checked);
...
//BAG при удалении региона не работает выбор девайсов
